...
export default function HomePage() {
  // STATE UNTUK MENYIMPAN DATA STATISTIK DARI DATABASE
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        console.error("Gagal mengambil statistik transparansi:", error);
      }
    };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors duration-500 selection:bg-red-500 selection:text-white">
      ...
      <main className="flex-1">
        ...
        {/* 2. STATISTIK TRANSPARANSI (DIPERBARUI SECARA DINAMIS) */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-3xl md:text-4xl font-extrabold mt-2">
                Data Penanganan Pelanggaran {new Date().getFullYear()}
              </p>
            </div>
